...
stream_chem_all <-
  list.files(path = "week4/data/", pattern = "*.csv") %>% 
  map_df(~read_csv(.))
stream_chem_all
...
stream_chem_data <- read_csv(here::here("week4", "data", 
                                        "HubbardBrook_weekly_stream_chemistry_1963-2025.csv"))
```
...
ggplot(stream_chem_data, aes(x = SO4,
                             y = pH)) +
  geom_point()
```
