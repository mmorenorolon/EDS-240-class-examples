...
ggplot(penguins, aes(x = bill_length_mm, y = bill_depth_mm, colour = body_mass_g)) + 
  geom_point() +
...
ggplot(penguins, aes(x = species)) +
  geom_bar(stat = "count") # count: default
```
...
ggplot(penguins, aes(x = species, fill = island)) +
  geom_bar(position = "stack") # stack is the default
```
