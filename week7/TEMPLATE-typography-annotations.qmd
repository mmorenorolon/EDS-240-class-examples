...
#........................create annotation.......................
annotation <- glue::glue("Santa Barbara meets deficts through diverse water sources
...
water_plot <- ggplot(sbc_subbasin_monthly) +
  ...
  theme(
    plot.title = ggtext::element_markdown(family = "sarala", face = "bold", size = rel(0.98),
                              color = pal["dark_gray"],
                              lineheight = 1.5),
    ...
    axis.title.x = element_text(family = "noto-sans", 
                                size = rel(0.5),
                                margin = margin(t = 15)),
    axis.text = element_text(faamily = "red", 
                             size = rel(0.7), color = pal["light_gray"]),
...
ggsave(
  filename = here::here("week7", "images", "sbc-hydro-larger.png"),
  plot = water_plot,
  device = "png",
  height = 9,
  width = 14,
